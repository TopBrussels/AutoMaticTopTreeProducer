...
#process.p = cms.Path(process.totalKinematicsFilter*process.printEvents)
...
process.p0 = cms.Path(
    process.totalKinematicsFilter*process.printEvents*process.patseq*
...
# rename output file
process.out.fileName = "TTJets_Madgraph_Fall11_42_PAT_test1_newJEC_Type1METcorr.root"
