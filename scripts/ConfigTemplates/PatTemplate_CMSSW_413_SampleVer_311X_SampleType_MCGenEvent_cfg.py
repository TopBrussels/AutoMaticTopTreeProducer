...
## ------------------------------------------------------
#
process.GlobalTag.globaltag =  cms.string('START311_V2::All')     ##  (according to https://twiki.cern.ch/twiki/bin/view/CMS/SWGuideFrontierConditions)
#                                         ##
process.source.fileNames = [          ##
#'file:/user/pvmulder/NewEraOfDataAnalysis/TopTree/CMSSW_3_11_2/src/TopBrussels/TopTreeProducer/test/test311X_RECO.root'
'/store/mc/Winter10/TTJets_TuneZ2_7TeV-madgraph-tauola/AODSIM/E7TeV_ProbDist_2011Flat_BX156_START39_V8-v1/0001/EC63A9B4-1627-E011-A17E-001A4BA59632.root'
...
process.out.outputCommands.extend(cms.vstring("drop cleanPat*_*_*_*"))
...
process.out.fileName = cms.untracked.string('test311X_PAT_genEvent.root')            ##  (e.g. 'myTuple.root')
#                                         ##
