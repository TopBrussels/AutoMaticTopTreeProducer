...
#        duplicateCheckMode = cms.untracked.string('noDuplicateCheck'),
	fileNames = cms.untracked.vstring('file:test311X_PAT_data.root')
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string('test311X_TOPTREE_fromPAT_data.root'),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
		...
		doCaloJet = cms.untracked.bool(True), #need to be removed: is to use JetProducer
	...
	producersNames = cms.PSet(
		...
		hltProducer4th = cms.InputTag("TriggerResults","","REDIGI41X"),
