...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:Data_42X_Final1_PAT.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("Data_42X_SyncEx_TOPTREE.root"),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
	...
	producersNames = cms.PSet(
		...
		velectronProducer = cms.untracked.vstring("selectedPatElectrons","selectedPatElectronsPF2PAT","selectedPatElectronsPF2PATNoLeptonCleaning"),
