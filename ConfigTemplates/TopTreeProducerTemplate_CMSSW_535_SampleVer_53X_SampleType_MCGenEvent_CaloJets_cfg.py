...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('file:TTJets_Madgraph_Summer12_PAT.root'),
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("TTJets_Madgraph_Summer12_TOPTREE.root"),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
	...
	producersNames = cms.PSet(
		...
		vgenJetProducer = cms.untracked.vstring("ak5GenJetsNoNu","ak5GenJetsNoMuNoNu"),
