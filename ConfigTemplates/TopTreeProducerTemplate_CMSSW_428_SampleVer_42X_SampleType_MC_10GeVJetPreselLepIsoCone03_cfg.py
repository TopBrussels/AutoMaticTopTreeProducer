...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:WJets_Madgraph_Summer11_Final1_PAT.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("WJets_Madgraph_Summer11_Final1_TOPTREE.root"),
