...
#process.combinedMVABJetTagsAODPF2PAT = process.combinedSecondaryVertexMVABJetTagsAODPF2PAT.clone()
...
process.btaggingJetTagsAODPF2PAT.remove(process.combinedMVABJetTagsAODPF2PAT)
...
addJetCollection(process,cms.InputTag('ak5CaloJets'),
                 ...
                 doL1Cleaning = False,
                 doL1Counters = False,
                 genJetCollection=cms.InputTag("ak5GenJetsNoMuNoNu"),
                 doJetID      = True,
                 jetIdLabel   = "ak5"
                 )

process.patJetsAK5Calo.discriminatorSources = cms.VInputTag(
        cms.InputTag("combinedSecondaryVertexBJetTagsAK5Calo"),
        cms.InputTag("combinedSecondaryVertexRetrainedBJetTagsAK5Calo"),
        cms.InputTag("combinedSecondaryVertexMVABJetTagsAK5Calo"),
        cms.InputTag("jetBProbabilityBJetTagsAK5Calo"),
        cms.InputTag("jetProbabilityBJetTagsAK5Calo"),
        cms.InputTag("simpleSecondaryVertexHighEffBJetTagsAK5Calo"),
        cms.InputTag("simpleSecondaryVertexHighPurBJetTagsAK5Calo"),
        cms.InputTag("softElectronByPtBJetTagsAK5Calo"),
        cms.InputTag("softElectronByIP3dBJetTagsAK5Calo"),
        cms.InputTag("softMuonBJetTagsAK5Calo"),
        cms.InputTag("softMuonByPtBJetTagsAK5Calo"),
        cms.InputTag("softMuonByIP3dBJetTagsAK5Calo"),
        cms.InputTag("trackCountingHighEffBJetTagsAK5Calo"),
        cms.InputTag("trackCountingHighPurBJetTagsAK5Calo")
    )

process.softElectronByPtBJetTagsAK5Calo = process.softMuonByIP3dBJetTagsAK5Calo.clone(
	jetTagComputer = 'softLeptonByPt',
	tagInfos = cms.VInputTag( cms.InputTag("softElectronTagInfosAK5Calo") )
	)
process.softElectronByIP3dBJetTagsAK5Calo = process.softMuonByIP3dBJetTagsAK5Calo.clone(
	jetTagComputer = 'softLeptonByIP3d',
	tagInfos = cms.VInputTag( cms.InputTag("softElectronTagInfosAK5Calo") )
	)
process.combinedSecondaryVertexRetrainedBJetTagsAK5Calo = process.combinedSecondaryVertexBJetTagsAK5Calo.clone(
   	jetTagComputer = 'combinedSecondaryVertexRetrained',
    )

process.btaggingJetTagsAK5Calo.remove(process.combinedMVABJetTagsAK5Calo)

process.btaggingJetTagsAK5Calo.replace(process.softMuonByIP3dBJetTagsAK5Calo, process.softMuonByIP3dBJetTagsAK5Calo+process.softElectronByPtBJetTagsAK5Calo+process.softElectronByIP3dBJetTagsAK5Calo)

process.btaggingJetTagsAK5Calo.replace(process.combinedSecondaryVertexBJetTagsAK5Calo,process.combinedSecondaryVertexBJetTagsAK5Calo+process.combinedSecondaryVertexRetrainedBJetTagsAK5Calo)
...
# rename output file
process.out.fileName = "TTJets_Madgraph_Summer12_PAT.root"
