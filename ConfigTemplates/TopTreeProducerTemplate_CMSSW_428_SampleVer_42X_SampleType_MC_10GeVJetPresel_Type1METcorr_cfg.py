...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:TTJets_Madgraph_Fall11_42_PAT_test2_newJEC_Type1METcorr.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("TTJets_Madgraph_Fall11_42_TOPTREE_test1_newJEC_Type1METcorr.root"),
