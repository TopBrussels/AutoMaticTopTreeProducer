...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:Data_42_PAT_test1_newJEC_Type1METcorr.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("Data_42_TOPTREE_test1_newJEC_Type1METcorr.root"),
