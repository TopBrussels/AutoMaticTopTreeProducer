...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:TTJets_Madgraph_Fall11_42_PAT_MC_TEST.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("file:TTJets_Madgraph_Fall11_42_TopTree_MC_TEST.root"),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
	...
	producersNames = cms.PSet(
		...
		electronNewId = cms.untracked.bool(True) 
	)
)
