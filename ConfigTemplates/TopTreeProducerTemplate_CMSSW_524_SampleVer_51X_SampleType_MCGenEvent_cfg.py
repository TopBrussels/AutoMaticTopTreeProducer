...
process.source = cms.Source("PoolSource",
                            ...
                            #skipEvents = cms.untracked.uint32(1799) 
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("TTJets_Madgraph_Summer11_Final1_TOPTREE.root"),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
		...
		runSuperCluster = cms.untracked.bool(True),#true only if SuperCluster are stored, needed for a lot of electron Id variables
    ...
    pileUpProducer = cms.InputTag("addPileupInfo"),
		...
		vpfmetProducer = cms.untracked.vstring("patMETsPF2PAT","patMETsPF2PATNoLeptonCleaning"), #previously: PFmetProducer = cms.InputTag("patMETsPF2PAT"), which is not Type 1 corrected. Note that patType1CorrectedPFMet is still using PF2PAT.
