...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring('file:ZJets_Madgraph_Summer11_Final1_PAT.root')
)
...
process.analysis = cms.EDAnalyzer("TopTreeProducer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string("ZJets_Madgraph_Summer11_Final1_TOPTREE.root"),
...
#		signalGenerator = cms.untracked.string('MADGRAPH'),
	...
	producersNames = cms.PSet(
		...
		vpfJetProducer = cms.untracked.vstring("selectedPatJetsAK5PF","selectedPatJetsPF2PAT","selectedPatJetsPF2PATNoLeptonCleaning"),
		vJPTJetProducer = cms.untracked.vstring("selectedPatJetsAK5JPT"),
		vmuonProducer = cms.untracked.vstring("selectedPatMuons","selectedPatMuonsPF2PAT","selectedPatMuonsPF2PATNoLeptonCleaning"),
		velectronProducer = cms.untracked.vstring("selectedPatElectrons","selectedPatElectronsPF2PAT","selectedPatElectronsPF2PATNoLeptonCleaning"),# if electronTriggerMatching == true, change the electron inputTag to "cleanPatElectronsTriggerMatch"
		CalometProducer = cms.InputTag("patMETsAK5Calo"),
		vpfmetProducer = cms.untracked.vstring("patMETsPF2PAT","patMETsPF2PATNoLeptonCleaning"),
