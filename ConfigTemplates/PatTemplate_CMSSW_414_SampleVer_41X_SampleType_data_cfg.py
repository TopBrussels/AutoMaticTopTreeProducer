...
#		'dcap:///pnfs/iihe/cms/ph/sc4/store/mc/Spring11/TTJets_TuneZ2_7TeV-madgraph-tauola/AODSIM/PU_S1_START311_V1G1-v1/0001/0E00730B-164E-E011-BA88-E0CB4E1A117F.root '
		'file:/user/blyweert/TopTreeDevelopment/CMSSW_4_1_4_patch2/src/TopBrussels/TopTreeProducer/PF2PATcfg/test_41X_data_AOD.root'
...
process.load("RecoVertex.PrimaryVertexProducer.OfflinePrimaryVertices_cfi") #added
...
process.patseq = cms.Sequence(
    ...
    process.HBHENoiseFilter*
  	process.offlinePrimaryVertices * #added
...
# rename output file
process.out.fileName = cms.untracked.string('test_414_Data_PAT.root')
